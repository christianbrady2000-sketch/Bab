...
if run:
    ...
    with st.spinner(f"Fetching {comparison_ticker} data..."):
    ...
    with tab4:
        ...
        if comparison_df is not None and df is not None:
            ...
            summary_stats = pd.DataFrame({
                'Metric': ['Min', 'Max', 'Final Normalized Value'],
                ticker: [
